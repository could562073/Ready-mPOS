...
**目前 = `2.2.2`**（雲端寫入 403 診斷探針 + 同步失敗使用者提示 → PATCH）。
...
│       │   ├── SyncErrorBanner.tsx    # 同步失敗提示橫幅（跨所有 tab，琥珀色，2.2.2）
